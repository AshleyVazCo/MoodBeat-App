...
import ConfirmationModalLM from '../components/ConfirmationModalLM';

const VerificationModalLM = ({ onClose }) => {
      ...
      {showConfirmationModal ? (
        ...
        <View style={styles.modalContent}>
          <View style={styles.headerContainer}>
            ...
            <Image style={styles.image} source={require('../../assets/icons/logoPurple.png')} />
          </View>
...
export default VerificationModalLM;

...
import DescriptionContentLM from "./DescriptionContentLM";
import BackgroundContentLM from "./BackgroundContentLM";
import TextContentLM from "./TextContentLM";

const ThreeTabMenuDM = () => {
  ...
  return (
    <View style={styles.tabContainer}>
      ...
      <View style={styles.content}>
        {activeTab === "Description" && <DescriptionContentLM />}
        {activeTab === "Background" && <BackgroundContentLM />}
        {activeTab === "Text" && <TextContentLM />}
      </View>
    </View>
